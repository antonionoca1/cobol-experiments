...
01  WS-DATE           PIC 9(8).
01  WS-CURR-YEAR      PIC 9(4) VALUE 0.
01  WS-CURR-MONTH     PIC 9(2) VALUE 0.
01  WS-CURR-DAY       PIC 9(2) VALUE 0.
01  EOF-FLAG          PIC X VALUE 'N'.
    88  EOF-REACHED   VALUE 'Y'.
    88  NOT-EOF       VALUE 'N'.
PROCEDURE DIVISION.
    ACCEPT WS-DATE FROM DATE YYYYMMDD
    MOVE WS-DATE(1:4) TO WS-CURR-YEAR.
    MOVE WS-DATE(5:2) TO WS-CURR-MONTH.
    MOVE WS-DATE(7:2) TO WS-CURR-DAY.
    OPEN INPUT CSV-FILE.
